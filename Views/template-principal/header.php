<!-- Codigo de la vista de la pagina principal, con enfasis en el header, cabecera de la pagina-->
<!-- Hola -->
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Codigo para generar los iconos del logo (en pestaña) dependiendo del dispositivo (movil) -->
